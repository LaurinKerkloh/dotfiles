...
systems. Refer to [this repository](https://github.com/laurinkerkloh/arch) for the
...
The `laurinpc` and `laurinlaptop` directories contain configuration specific to the
...
```shell
git clone git@github.com:laurinkerkloh/dotfiles.git ~/.dotfiles
```
