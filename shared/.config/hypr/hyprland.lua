...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("uwsm app -- alacritty", { workspace = "1 silent" })
    hl.exec_cmd("uwsm app -- firefox", { workspace = "2 silent" })

    hl.exec_cmd("uwsm app -- thunderbird", { workspace = "3 silent" })
    hl.exec_cmd("uwsm app -- signal-desktop", { workspace = "3 silent" })
    hl.exec_cmd("uwsm app -- gtk-launch whatsapp_web", { workspace = "3 silent" })

    hl.exec_cmd("uwsm app -- keepassxc", { workspace = "10 silent" })
end)
...
hl.config({
    ...
    group = {
        groupbar = {
            ...
            text_color_inactive = colors.overlay0,
            col = {
        ...
        col = {
            ...
            border_inactive = "rgba(" .. colors.overlay0Alpha .. "aa)",
        },
    },
})
...
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("uwsm app -- airpods"))
...
hl.window_rule({
    name = "comms",
    match = { class = [[^((org\.mozilla\.Thunderbird|signal)|.*whatsapp.*)$]] },
    workspace = 3,
    group = "set",
})
